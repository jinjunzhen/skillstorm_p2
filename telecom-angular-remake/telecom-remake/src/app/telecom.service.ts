...
const phone_url = 'http://localhost:9001/phones/phone';
const account_url = 'http://localhost:9001/accounts/account';
const plan_url = 'http://localhost:9001/plans/plan';
const getOneAccount_url = 'http://localhost:9001/accounts/login';
const putPlanToAcct_url_1 = 'http://localhost:9001/plans/';
const putPlanToAcct_url_2 = '/addPlan/';
const test_url = "http://localhost:9001/phones/2/addPhone/1";
const generateNewNumber_url = "http://localhost:9001/phones/phone/generateNumber";

const putPhoneToPlan_url_1 = "http://localhost:9001/phones/";
